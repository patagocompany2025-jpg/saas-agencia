...
app.get('/auth/start', (req, res) => {
  console.log('=== TESTE AUTORIZAÇÃO FINAL ===');
...
app.listen(5003, () => {
  console.log('Servidor final rodando em http://localhost:5003');
  ...
  console.log('');
  console.log('IMPORTANTE: Use a URL que já está configurada no painel!');
  console.log('URL configurada: https://75d955dfdd07.ngrok-free.app/callback');
});
