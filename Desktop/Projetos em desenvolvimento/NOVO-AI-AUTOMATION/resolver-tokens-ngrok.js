...
console.log('🔧 RESOLVENDO TOKENS EXPIRADOS DO CONTA AZUL (NGROK)');
console.log('====================================================');
console.log('');

const CLIENT_ID = '3p4m8aht6lvqgmsri1p12pko26';
const CLIENT_SECRET = 'jhfqsrgjda8oroiqaccgoqhpu3eopm1pfektjfo1sls8hb51mbs';
const REDIRECT_URI = 'https://3346f1e49c39.ngrok-free.app/oauth/callback'; // URL do ngrok
...
console.log('1. Certifique-se que o servidor está rodando: node oauth-callback-server.js');
console.log('2. Certifique-se que o ngrok está rodando: ngrok http 3000');
console.log('3. Abra esta URL no navegador:');
console.log('');
console.log(authUrl);
console.log('');
console.log('4. Faça login na Conta Azul');
console.log('5. Autorize a aplicação');
console.log('6. Você será redirecionado para o ngrok');
console.log('7. O código será exibido na página');
console.log('8. Copie APENAS o código (parte após code=)');
console.log('');
