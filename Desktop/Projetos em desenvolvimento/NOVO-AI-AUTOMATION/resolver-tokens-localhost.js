...
console.log('🔧 RESOLVENDO TOKENS EXPIRADOS DO CONTA AZUL (LOCALHOST)');
console.log('========================================================');
console.log('');

const CLIENT_ID = '3p4m8aht6lvqgmsri1p12pko26';
const CLIENT_SECRET = 'jhfqsrgjda8oroiqaccgoqhpu3eopm1pfektjfo1sls8hb51mbs';
const REDIRECT_URI = 'http://localhost:3000/oauth/callback'; // Usando localhost
...
console.log('5. Você será redirecionado para localhost:3000');
console.log('6. O código será exibido na página');
