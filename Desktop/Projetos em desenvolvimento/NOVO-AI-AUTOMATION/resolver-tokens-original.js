...
console.log('🔧 RESOLVENDO TOKENS EXPIRADOS DO CONTA AZUL (URL ORIGINAL)');
console.log('============================================================');
console.log('');

const CLIENT_ID = '3p4m8aht6lvqgmsri1p12pko26';
const CLIENT_SECRET = 'jhfqsrgjda8oroiqaccgoqhpu3eopm1pfektjfo1sls8hb51mbs';
const REDIRECT_URI = 'https://lojanovoisrael.com.br/oauth/callback'; // URL original configurada
